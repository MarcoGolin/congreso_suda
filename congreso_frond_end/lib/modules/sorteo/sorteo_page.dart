...
class _SorteoPageState extends State<SorteoPage> {
  ...
  void initState() {
    ...
    _reactionDisposer = reaction((_) => controller.ganador, (Usuario? ganador) {
      if (ganador != null) {
  ...
  void _mostrarGanador(Usuario ganador) {
    showDialog(
      context: context,
      builder: (context) {
          ...
          children: [
            AlertDialog(
              ...
              content: Column(
                ...
                children: [
                  CachedNetworkImage(
                    imageUrl: controller.auspicianteSeleccionado!.url,
                    height: 150,
                    width: 150,
                  ),
                  ...
                  Text(
                    'R.A: ${ganador.registroAcademico}',
                    style: Theme.of(context).textTheme.titleMedium,
                  ),
                  Text('Institución: ${ganador.institucion}'),
                  Text('Semestre: ${ganador.semestre}'),
                ],
              ),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        actions: [
          //cambiar tipo de usuario para sorteo entre staff o participantes
          Observer(
            builder: (_) => DropdownButtonHideUnderline(
              child: DropdownButton<String>(
                value: controller.tipoSorteo,
                dropdownColor: Colors.grey[900],
                style: const TextStyle(color: Colors.white, fontSize: 14),
                items: ['Congresista', 'Staff']
                    .map(
                ...
                onChanged: (String? nuevoTipo) {
                  if (nuevoTipo != null) {
                    controller.setTipoSorteo(nuevoTipo);
                  }
                },
              ),
            ),
                  ...
                  ElevatedButton.icon(
                    ...
                    onPressed:
                        controller.isLoading ||
                            controller.auspicianteSeleccionado == null
                        ? null
                        : controller.consultaCongresistaDisponiblesSorteo,
                  ),
                  FadeInUp(
                    child: Padding(
