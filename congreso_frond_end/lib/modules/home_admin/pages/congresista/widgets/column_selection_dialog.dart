...
class ColumnSelectionDialog extends StatelessWidget {
  final CongresistaCtrl controller;

  const ColumnSelectionDialog({super.key, required this.controller});
              ...
              Expanded(
                child: ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    final isSelected =
                        controller.categoriasSeleccionadas[categoria] ?? false;
                    ...
                    return Card(
                      ...
                      child: ExpansionTile(
                        ...
                        children: columnas.map((columna) {
                          final isColumnaSelected = columnasSeleccionadas
                              .contains(columna);
                          return CheckboxListTile(
                            ...
                            onChanged: (_) =>
                                controller.toggleColumna(categoria, columna),
                            dense: true,
        ...
        actions: [
          ...
          ElevatedButton.icon(
            onPressed: controller.columnasSeleccionadas.isEmpty
                ...
                : () {
                    Navigator.of(context).pop();
                    controller.confirmarExportacion();
                  },
