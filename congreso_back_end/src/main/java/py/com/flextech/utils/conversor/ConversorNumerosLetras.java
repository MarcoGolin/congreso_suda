...
public class ConversorNumerosLetras {
	...
	public ConversorNumerosLetras(int n) {
		numero = n;
		flag = 0;
	}
	...
	public String convertir(String numero, boolean mayusculas, boolean imprimeMoeda) {
//		String num[] = numero.split(",");
		BigDecimal nr = new BigDecimal(numero);
		nr.intValue();
		num_letras = decmillon(nr.intValue());
		String valor = "";
		if (mayusculas) {
			valor = num_letras.toUpperCase();
			if (imprimeMoeda) {
				valor = valor + " GUARANIES";
			}
		} else {
			valor = num_letras;
			if (imprimeMoeda) {
	...
	public String convertir(String numero, boolean mayusculas) {
		...
		num_letras = decmillon(new BigDecimal(numero).intValue());
		String valor = "";
		if (mayusculas) {
			valor = num_letras.toUpperCase();
		} else {
